...
import com.cuatroenlineaj.modelo.TipoUsuario;
import com.cuatroenlineaj.controlador.util.JsfUtil;
import com.cuatroenlineaj.controlador.util.JsfUtil.PersistAction;
...
public class TipoUsuarioController implements Serializable {
    ...
    @EJB
    private com.cuatroenlineaj.controlador.TipoUsuarioFacade ejbFacade;
